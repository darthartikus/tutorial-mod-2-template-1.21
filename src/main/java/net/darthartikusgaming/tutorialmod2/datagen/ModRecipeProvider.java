package net.darthartikusgaming.tutorialmod2.datagen;
...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RAW_PINK_GARNET,9)
                ...
                .offerTo(exporter, Identifier.of(TutorialMod2.MOD_ID, "raw_pink_garnet_from_raw_pink_garnet_block"));

        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RAW_PINK_GARNET,32)
                .input(ModBlocks.MAGIC_BLOCK)
                .criterion(hasItem(ModBlocks.MAGIC_BLOCK), conditionsFromItem(ModBlocks.MAGIC_BLOCK))
                .offerTo(exporter, Identifier.of(TutorialMod2.MOD_ID, "raw_pink_garnet_from_magic_block"));
    }
}
